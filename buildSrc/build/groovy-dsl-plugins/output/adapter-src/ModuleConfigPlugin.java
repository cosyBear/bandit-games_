...
/**
 * Precompiled module-config script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ModuleConfigPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ModuleConfig").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ModuleConfig").asSubclass(BasicScript.class);
