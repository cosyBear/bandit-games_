INSERT INTO GameEntity (gameId, gameName, gameType, imageUrl, favourite)
VALUES
    ('e7a1c1d2-f18e-4e6a-b3a5-6dba403b62a1', 'Chess Master', 'BOARD_GAME', 'https://example.com/images/chess.png', false),
    ('a2b7c0e4-3d11-4b5b-8297-3e45fc173c81', 'Need for Speed', 'RACING', 'https://example.com/images/nfs.png', true),
    ('f2d3b5c6-9a21-4d87-b6a1-8cb17de38145', 'Fortnite Battle', 'SHOOTER', 'https://example.com/images/fortnite.png', false),
    ('d4f7e6a9-213a-4b8c-9f47-5a01e24c90b2', 'Minecraft Builder', 'SANDBOX', 'https://example.com/images/minecraft.png', true),
    ('b1f5a7d9-14c8-43ba-a71d-0f62d9e39124', 'Portal Puzzle', 'PUZZLE', 'https://example.com/images/portal.png', false);
INSERT INTO AchievementEntity (achievementId, achievementName, achievementDescription, imageUrl, achieved, game_id)
VALUES
