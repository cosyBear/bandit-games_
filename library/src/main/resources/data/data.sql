-- Insert Players
INSERT INTO player_entity (player_id)
VALUES
    (UUID_TO_BIN('123e4567-e89b-12d3-a456-426614174000')); -- Add any necessary Player ID(s)

-- Insert Libraries and associate with Players
INSERT INTO library_entity (library_id, player_id)
VALUES
    (UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000'), UUID_TO_BIN('123e4567-e89b-12d3-a456-426614174000'));

-- Insert Games and associate with Libraries
INSERT INTO game_entity (game_id, game_name, game_type, image_url, favourite, library_id)
VALUES
    (UUID_TO_BIN('e7a1c1d2-f18e-4e6a-b3a5-6dba403b62a1'), 'Chess Master', 'BOARD_GAME', 'https://example.com/images/chess.png', false, UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000')),
    (UUID_TO_BIN('a2b7c0e4-3d11-4b5b-8297-3e45fc173c81'), 'Need for Speed', 'RACING', 'https://example.com/images/nfs.png', true, UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000')),
    (UUID_TO_BIN('f2d3b5c6-9a21-4d87-b6a1-8cb17de38145'), 'Fortnite Battle', 'SHOOTER', 'https://example.com/images/fortnite.png', false, UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000')),
    (UUID_TO_BIN('d4f7e6a9-213a-4b8c-9f47-5a01e24c90b2'), 'Minecraft Builder', 'SANDBOX', 'https://example.com/images/minecraft.png', true, UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000')),
    (UUID_TO_BIN('b1f5a7d9-14c8-43ba-a71d-0f62d9e39124'), 'Portal Puzzle', 'PUZZLE', 'https://example.com/images/portal.png', false, UUID_TO_BIN('456e7891-e89b-12d3-a456-426614174000'));
