...
import kdg.be.prog6.lobby.adapters.out.entity.LobbyEntity;
import kdg.be.prog6.lobby.adapters.out.entity.LobbyStatusEntity;
import kdg.be.prog6.lobby.domain.Lobby;
import kdg.be.prog6.lobby.domain.LobbyStatus;
